...
print(p1)
ggsave("output/figures/other/ch4_component_boxplot_grid.png", p1, width = 14, height = 12, dpi = 300)
...
ggsave("output/figures/other/ch4_component_by_plot_month.png", p2_switched_simple, width = 14, height = 12, dpi = 300)
...
print(p_ridges)
ggsave("output/figures/other/ch4_component_ridges.png", p_ridges, width = 14, height = 12, dpi = 300)
...
print(p_heatmap)
ggsave("output/figures/other/ch4_component_heatmap.png", p_heatmap, width = 12, height = 10, dpi = 300)
...
ggsave("output/figures/other/ch4_component_jitterbox.png", p_jitter_box_ch4, width = 14, height = 12, dpi = 300)
...
ggsave("output/figures/other/co2_component_jitterbox.png", p_jitter_box_co2, width = 14, height = 12, dpi = 300)
...
print(p_co2_simple)
ggsave("output/figures/other/co2_component_simple.png", p_co2_simple, width = 8, height = 6, dpi = 300)
...
ggsave("output/figures/other/combined_ch4_co2_by_component.png", p_combined_flux_asinh, width = 12, height = 8, dpi = 300)
