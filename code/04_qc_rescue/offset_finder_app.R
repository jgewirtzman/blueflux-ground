...
prepare_flux_data <- function() {
  # Load tree flux data
  tree_flux <- read_csv("data/field_notes/blueflux compiled tree fluxes_additional.csv") %>%
  ...
  soil_water_flux <- read_csv("data/field_notes/BlueFlux Dataset_soils_water.csv") %>%
