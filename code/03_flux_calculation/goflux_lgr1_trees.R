...
lgr1_auxfile <- read_csv("intermediate/auxfiles/tree_auxfile_lgr1_goflux.csv") %>%
...
# Step 5: Save results
write_csv(CO2_flux_lgr1, "intermediate/CO2_flux_lgr1_results.csv")
cat("\nCO2 flux results saved to: intermediate/CO2_flux_lgr1_results.csv\n")

if(exists("CH4_flux_lgr1")) {
  write_csv(CH4_flux_lgr1, "intermediate/CH4_flux_lgr1_results.csv")
