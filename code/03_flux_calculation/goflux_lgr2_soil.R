...
# Load LGR2 auxfile
lgr2_auxfile <- read_csv("intermediate/auxfiles/soilwater_auxfile_lgr2_goflux.csv") %>%
...
write_csv(manID.lgr2, "intermediate/lgr2_manual_identification_results_soil.csv")
...
# Save flux results
write_csv(CO2_flux_lgr2, "intermediate/CO2_flux_lgr2_results_soil.csv")
if(exists("CH4_flux_lgr2")) {
  write_csv(CH4_flux_lgr2, "intermediate/CH4_flux_lgr2_results_soil.csv")
}
...
write_csv(CO2_best_lgr2, "intermediate/CO2_best_flux_lgr2_results_soil.csv")
if(exists("CH4_best_lgr2")) {
  write_csv(CH4_best_lgr2, "intermediate/CH4_best_flux_lgr2_results_soil.csv")
}
...
flux2pdf(
  ...
  outfile = "intermediate/LGR2_flux_plots_complete_soil.pdf",
  width = 11.6,
  height = 8.2
)
...
write_csv(final_dataset, "intermediate/LGR2_final_complete_dataset_soil.csv")
