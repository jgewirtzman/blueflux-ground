...
lgr1_auxfile <- read_csv("intermediate/auxfiles/soilwater_auxfile_lgr1_goflux.csv") %>%
...
# Save the results
write_csv(manID.lgr1, "intermediate/lgr1_manual_identification_results.csv")
...
# Step 5: Save results
write_csv(CO2_flux_lgr1, "intermediate/CO2_flux_lgr1_results_soil.csv")
cat("\nCO2 flux results saved to: intermediate/CO2_flux_lgr1_results.csv\n")

if(exists("CH4_flux_lgr1")) {
  write_csv(CH4_flux_lgr1, "intermediate/CH4_flux_lgr1_results_soil.csv")
...
# Step 6: Save results
write_csv(CO2_best_lgr1, "intermediate/CO2_best_flux_lgr1_results_soil.csv")
cat("\nCO2 best flux results saved to: intermediate/CO2_best_flux_lgr1_results.csv\n")

if(exists("CH4_best_lgr1")) {
  write_csv(CH4_best_lgr1, "intermediate/CH4_best_flux_lgr1_results_soil.csv")
...
write_csv(summary_report, "intermediate/CO2_summary_report_lgr1_soil.csv")
...
flux2pdf(
  ...
  outfile = "intermediate/LGR1_flux_plots_complete_soil.pdf",
...
write_csv(final_dataset, "intermediate/LGR1_final_complete_dataset_soil.csv")
