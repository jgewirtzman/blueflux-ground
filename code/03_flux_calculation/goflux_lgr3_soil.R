...
# Load LGR3 auxfile
lgr3_auxfile <- read_csv("intermediate/auxfiles/soilwater_auxfile_lgr3_goflux.csv") %>%
...
write_csv(manID.lgr3, "intermediate/lgr3_manual_identification_results_soil.csv")
...
# Save flux results
write_csv(CO2_flux_lgr3, "intermediate/CO2_flux_lgr3_results_soil.csv")
if(exists("CH4_flux_lgr3")) {
  write_csv(CH4_flux_lgr3, "intermediate/CH4_flux_lgr3_results_soil.csv")
}
...
write_csv(CO2_best_lgr3, "intermediate/CO2_best_flux_lgr3_results_soil.csv")
if(exists("CH4_best_lgr3")) {
  write_csv(CH4_best_lgr3, "intermediate/CH4_best_flux_lgr3_results_soil.csv")
}
...
flux2pdf(
  ...
  outfile = "intermediate/LGR3_flux_plots_complete_soil.pdf",
  width = 11.6,
  height = 8.2
)
...
write_csv(final_dataset, "intermediate/LGR3_final_complete_dataset_soil.csv")
