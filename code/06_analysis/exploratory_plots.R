...
# Saves PNGs to output/figures/exploratory/
# =============================================================================
...
dir.create("output/figures/exploratory", showWarnings = FALSE, recursive = TRUE)
...
ggsave("output/figures/exploratory/expl_ch4_vs_co2.png", p1,
...
ggsave("output/figures/exploratory/expl_ch4_vs_diameter.png", p2,
       width = 8, height = 5, dpi = 200)
ggsave("output/figures/exploratory/expl_ch4_vs_diameter_species.png", p2b,
...
ggsave("output/figures/exploratory/expl_root_vs_stem_rhma.png", p3,
...
ggsave("output/figures/exploratory/expl_flux_vs_pneumatophore_density.png", p4,
...
ggsave("output/figures/exploratory/expl_ch4_above_water_vs_sediment.png", p5a,
       width = 5, height = 5, dpi = 200)
ggsave("output/figures/exploratory/expl_ch4_above_water_vs_sediment_faceted.png", p5b,
       width = 10, height = 5, dpi = 200)
cat("Saved: expl_ch4_above_water_vs_sediment.png, _faceted.png\n")

cat("\n===== All exploratory plots saved to output/figures/exploratory/ =====\n")
