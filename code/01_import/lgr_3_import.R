...
# 
# # Load LGR3 auxfile
# lgr3_auxfile <- read_csv("intermediate/auxfiles/tree_auxfile_lgr3_goflux.csv") %>%
...
# 
# # Save flux results
# write_csv(CO2_flux_lgr3, "intermediate/CO2_flux_lgr3_results.csv")
# if(exists("CH4_flux_lgr3")) {
#   write_csv(CH4_flux_lgr3, "intermediate/CH4_flux_lgr3_results.csv")
# }
# 
...
# write_csv(CO2_best_lgr3, "intermediate/CO2_best_flux_lgr3_results.csv")
# if(exists("CH4_best_lgr3")) {
#   write_csv(CH4_best_lgr3, "intermediate/CH4_best_flux_lgr3_results.csv")
# }
# 
# # =============================================================================
# # STEP 6: CREATE PLOTS
...
# write_csv(final_dataset, "intermediate/LGR3_final_complete_dataset.csv")
# 
# # =============================================================================
# # SUMMARY
# # =============================================================================
