...
# Save flux results
write_csv(CO2_flux_lgr3, "flux_code/CO2_flux_lgr3_results_additional.csv")
if(exists("CH4_flux_lgr3")) {
  write_csv(CH4_flux_lgr3, "flux_code/CH4_flux_lgr3_results_additional.csv")
}
...
write_csv(CO2_best_lgr3, "flux_code/CO2_best_flux_lgr3_results_additional.csv")
if(exists("CH4_best_lgr3")) {
  write_csv(CH4_best_lgr3, "flux_code/CH4_best_flux_lgr3_results_additional.csv")
}
...
flux2pdf(
  ...
  outfile = "flux_code/LGR3_flux_plots_complete_additional.pdf",
  width = 11.6,
  height = 8.2
)
