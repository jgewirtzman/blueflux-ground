...
# Step 2: Load auxfile
cat("Loading auxfile...\n")
lgr3_auxfile <- read_csv("flux_code/auxfiles/lgr3_rescue_auxfile.csv") %>%
...
write_csv(manID.lgr3, "flux_code/lgr3_rescue_manual_identification.csv")
...
# Step 8: Save results
write_csv(CO2_best_lgr3, "flux_code/rescue_CO2_lgr3_results.csv")
if(!is.null(CH4_best_lgr3)) {
  write_csv(CH4_best_lgr3, "flux_code/rescue_CH4_lgr3_results.csv")
}
...
cat("\nFiles created:\n")
cat("- flux_code/lgr3_rescue_manual_identification.csv\n")
cat("- flux_code/rescue_CO2_lgr3_results.csv\n")
if(!is.null(CH4_best_lgr3)) {
  cat("- flux_code/rescue_CH4_lgr3_results.csv\n")
}
