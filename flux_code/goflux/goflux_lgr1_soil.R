...
lgr1_auxfile <- read_csv("flux_code/auxfiles/soilwater_auxfile_lgr1_goflux.csv") %>%
...
# Step 5: Save results
write_csv(CO2_flux_lgr1, "flux_code/CO2_flux_lgr1_results_soil.csv")
cat("\nCO2 flux results saved to: flux_code/CO2_flux_lgr1_results.csv\n")

if(exists("CH4_flux_lgr1")) {
  write_csv(CH4_flux_lgr1, "flux_code/CH4_flux_lgr1_results_soil.csv")
...
# Step 6: Save results
write_csv(CO2_best_lgr1, "flux_code/CO2_best_flux_lgr1_results_soil.csv")
cat("\nCO2 best flux results saved to: flux_code/CO2_best_flux_lgr1_results.csv\n")

if(exists("CH4_best_lgr1")) {
  write_csv(CH4_best_lgr1, "flux_code/CH4_best_flux_lgr1_results_soil.csv")
...
write_csv(summary_report, "flux_code/CO2_summary_report_lgr1_soil.csv")
...
flux2pdf(
  ...
  outfile = "flux_code/LGR1_flux_plots_complete_soil.pdf",
...
write_csv(final_dataset, "flux_code/LGR1_final_complete_dataset_soil.csv")
