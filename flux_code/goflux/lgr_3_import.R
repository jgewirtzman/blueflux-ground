...
# 
# # Load LGR3 auxfile
# lgr3_auxfile <- read_csv("flux_code/auxfiles/tree_auxfile_lgr3_goflux.csv") %>%
...
# 
# # Save flux results
# write_csv(CO2_flux_lgr3, "flux_code/CO2_flux_lgr3_results.csv")
# if(exists("CH4_flux_lgr3")) {
#   write_csv(CH4_flux_lgr3, "flux_code/CH4_flux_lgr3_results.csv")
# }
# 
...
# write_csv(CO2_best_lgr3, "flux_code/CO2_best_flux_lgr3_results.csv")
# if(exists("CH4_best_lgr3")) {
#   write_csv(CH4_best_lgr3, "flux_code/CH4_best_flux_lgr3_results.csv")
# }
# 
# # =============================================================================
# # STEP 6: CREATE PLOTS
...
# write_csv(final_dataset, "flux_code/LGR3_final_complete_dataset.csv")
# 
# # =============================================================================
# # SUMMARY
# # =============================================================================
