...
lgr1_auxfile <- read_csv("flux_code/auxfiles/lgr1_rescue_auxfile.csv")  %>%
...
manID.lgr1 <- click.peak2(
  ...
  save.plots = "flux_code/lgr1_flux_plots"  # Save plots for review
)
...
cat("Check the saved plots in flux_code/lgr1_flux_plots.pdf\n")

# Save the results
write_csv(manID.lgr1, "flux_code/lgr1_manual_identification_results_rescue.csv")
cat("Results saved to flux_code/lgr1_manual_identification_results.csv\n")
...
# manID.lgr1 <- read_csv("flux_code/lgr1_manual_identification_results.csv")
...
# Step 5: Save results
write_csv(CO2_flux_lgr1, "flux_code/CO2_flux_lgr1_results_rescue.csv")
cat("\nCO2 flux results saved to: flux_code/CO2_flux_lgr1_results.csv\n")

if(exists("CH4_flux_lgr1")) {
  write_csv(CH4_flux_lgr1, "flux_code/CH4_flux_lgr1_results_rescue.csv")
  cat("CH4 flux results saved to: flux_code/CH4_flux_lgr1_results.csv\n")
}
...
# Step 6: Save results
write_csv(CO2_best_lgr1, "flux_code/CO2_best_flux_lgr1_results.csv")
cat("\nCO2 best flux results saved to: flux_code/CO2_best_flux_lgr1_results.csv\n")

if(exists("CH4_best_lgr1")) {
  write_csv(CH4_best_lgr1, "flux_code/CH4_best_flux_lgr1_results.csv")
  cat("CH4 best flux results saved to: flux_code/CH4_best_flux_lgr1_results.csv\n")
}
...
write_csv(summary_report, "flux_code/CO2_summary_report_lgr1.csv")
cat("Summary report saved to: flux_code/CO2_summary_report_lgr1.csv\n")
...
cat("- flux_code/CO2_best_flux_lgr1_results.csv (complete results)\n")
cat("- flux_code/CO2_summary_report_lgr1.csv (key metrics only)\n")
...
flux2pdf(
  ...
  outfile = "flux_code/LGR1_flux_plots_complete.pdf",
  width = 11.6,                    # Standard page width
  height = 8.2                     # Standard page height
)

cat("All plots saved to: flux_code/LGR1_flux_plots_complete.pdf\n")

# Step 5: Create separate PDFs for CO2 and CH4 (optional)
flux2pdf(
  plot.list = CO2_plots_lgr1,
  outfile = "flux_code/LGR1_CO2_flux_plots.pdf",
  width = 11.6,
  height = 8.2
)
cat("CO2 plots saved to: flux_code/LGR1_CO2_flux_plots.pdf\n")

if(exists("CH4_plots_lgr1")) {
  flux2pdf(
    plot.list = CH4_plots_lgr1,
    outfile = "flux_code/LGR1_CH4_flux_plots.pdf",
    width = 11.6,
    height = 8.2
  )
  cat("CH4 plots saved to: flux_code/LGR1_CH4_flux_plots.pdf\n")
}
...
write_csv(final_dataset, "flux_code/LGR1_final_complete_dataset.csv")

# Print summary
cat("Final dataset created with", nrow(final_dataset), "rows and", ncol(final_dataset), "columns\n")
cat("Saved to: flux_code/LGR1_final_complete_dataset.csv\n")
