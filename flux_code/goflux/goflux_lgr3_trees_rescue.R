...
# Set data path
data_path <- "analyzer_data/LGR_GLA131/LGR3"
...
lgr3_auxfile <- read_csv("flux_code/auxfiles/lgr3_rescue_auxfile.csv") %>% mutate(start.time = as.POSIXct(start.time, tz = ifelse(lgr3_data_tz == "", "UTC", lgr3_data_tz)))
...
for(batch_num in 1:num_batches) {
  ...
  manID_batch <- click.peak2(
    ...
    sleep = 3,
    plot.lim = c(200, 1200),
    save.plots = paste0("flux_code/lgr3_batch_", batch_num, "_plots")
  )
...
#write_csv(manID.lgr3, "flux_code/lgr3_manual_identification_results.csv")
write_csv(manID.lgr3, "flux_code/lgr3_manual_identification_results_additional.csv")
...
# Save flux results
write_csv(CO2_flux_lgr3, "flux_code/CO2_flux_lgr3_results_rescue.csv")
if(exists("CH4_flux_lgr3")) {
  write_csv(CH4_flux_lgr3, "flux_code/CH4_flux_lgr3_results_rescue.csv")
}
...
write_csv(CO2_best_lgr3, "flux_code/CO2_best_flux_lgr3_results_rescue.csv")
if(exists("CH4_best_lgr3")) {
  write_csv(CH4_best_lgr3, "flux_code/CH4_best_flux_lgr3_results_rescue.csv")
}
...
flux2pdf(
  ...
  outfile = "flux_code/LGR3_flux_plots_complete_rescue.pdf",
  width = 11.6,
  height = 8.2
)
...
flux2pdf(
  ...
  outfile = "flux_code/LGR3_CO2_flux_plots.pdf",
  width = 11.6,
  height = 8.2
)
...
if(exists("CH4_plots_lgr3")) {
  flux2pdf(
    ...
    outfile = "flux_code/LGR3_CH4_flux_plots.pdf",
    width = 11.6,
    height = 8.2
  )
}
...
# flux2pdf(
#   plot.list = all_plots_lgr3,
#   outfile = "flux_code/LGR3_flux_plots_complete.pdf",
#   width = 11.6,
#   height = 8.2
# )
# 
...
write_csv(final_dataset, "flux_code/LGR3_final_complete_dataset_additional.csv")
...
cat("\nFiles created:\n")
cat("- flux_code/LGR3_final_complete_dataset.csv (complete final dataset)\n")
cat("- flux_code/CO2_best_flux_lgr3_results.csv (CO2 flux results)\n")
if(exists("CH4_best_lgr3")) {
  cat("- flux_code/CH4_best_flux_lgr3_results.csv (CH4 flux results)\n")
}
cat("- flux_code/LGR3_flux_plots_complete.pdf (all plots)\n")
