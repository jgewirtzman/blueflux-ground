...
lgr1_auxfile <- read_csv("flux_code/auxfiles/tree_auxfile_lgr1_goflux.csv") %>%
...
# Save the results
write_csv(manID.lgr1, "flux_code/lgr1_manual_identification_results.csv")
...
# Step 5: Save results
write_csv(CO2_flux_lgr1, "flux_code/CO2_flux_lgr1_results.csv")
cat("\nCO2 flux results saved to: flux_code/CO2_flux_lgr1_results.csv\n")

if(exists("CH4_flux_lgr1")) {
  write_csv(CH4_flux_lgr1, "flux_code/CH4_flux_lgr1_results.csv")
