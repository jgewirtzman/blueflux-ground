...
# Read the CSV file
df <- read.csv("field_notes/blueflux compiled tree fluxes.csv", stringsAsFactors = FALSE)
...
write.csv(df_filled, "flux_code/intermediate_files/blueflux_trees_filled.csv", row.names = FALSE)
