...
tryCatch({
  ...
  result <- assign_volumes_and_areas(
    ...
    mangrove_leaf_file = "field_notes/dimension_csvs/mangrove_leaf_data.csv",
    blueflux_file = "flux_code/intermediate_files/blueflux_trees_filled.csv"
  )
  
  # Save results
  write_csv(result, "flux_code/intermediate_files/main_trees_complete.csv")
  cat("\nResults saved to: flux_code/intermediate_files/main_trees_complete.csv\n")
